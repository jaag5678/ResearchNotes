...
\begin{document}
    ...
    \begin{frame}{Challenges: Part 4}
        ...
        %Ensuring the transformed model is sound, optimal and complete 
            ...
            %Optimality would guarantee that the transformed model is not too relaxed that it allows other unsafe transformations - No existing literature.
            %Completeness would guarantee that the transformed model also allows transformations safe under the base model - No existing literature.
        ...
        %Completeness 
            ...
            %Illegal executions either do not exist as a graph or they do but trigger certain axiom of hte model 
