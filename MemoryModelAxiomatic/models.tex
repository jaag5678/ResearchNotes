...
\begin{document}
    ...
    \begin{frame}{x86 Total Store Order (TSO)}
        ...
        \begin{itemize}
            ...
            \item {\rb} - Reads before (from reads) $\rb = (\rf^{-1};\mo_{|loc})$ 
            \item {\rfe} - Reads from external $\rf \setminus \po$
        \end{itemize}

        TAKE THE MODEL UNDERSTOOD FROM SOHAM OR JADE ALGLAVE's HERDING CATS
        
    \end{frame}

    \begin{frame}{x86 TSO: Alternative Definition}
        ...
        \begin{tasks}(2)
            ...
            \task {\rb;\xhb} irreflexive.
            \task {\rb;\mo} irreflexive.
            \task {\rb;\mo;\rfe;\po} irreflexive.
            \task {\rb;\mo;$[U \cup F]$;\po} irreflexive.
        \end{tasks}
